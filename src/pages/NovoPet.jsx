...
function NovoPet() {
  ...
  function salvarPet(data) {
    ...
    addPet(data)
      .then((resposta) => {
        // Espera a resposta do back end se os dados foram enviados
  ...
  // 1 º Pegar a lita de clientes e gerar as options
  // 2º Pegar os dados do formuário e enviar para o backend
